...
{\IEEEcompsocthanksitem Y. Ming, Y. Zhao, C. Wu, K. Li and J. Yin are with the College of Computer, National University of Defense Technology, Changsha 410073, P.R. China. E-mail: myw123@163.com, zhaoyawei09@nudt.edu.cn, wchknudt@163.com, li.kuan@163.com, and jpyin@nudt.edu.cn.
...
\begin{algorithm}[t]
    ...
    \begin{algorithmic}[1]
        ...
        \For {$s=1,2,...$} \% Asynchronously update the parameters by all trainers.
