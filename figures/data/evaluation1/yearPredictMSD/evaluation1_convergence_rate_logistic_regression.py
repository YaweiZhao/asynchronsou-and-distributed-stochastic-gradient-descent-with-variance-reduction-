...
def read_x(x1,y1,x2,y2,x3,y3,x4,y4):
	fn_without_tricks_disSVRG='/Users/yawei/Documents/papers/asynchronsou and distributed stochastic gradient descent with variance reduction /figures/data/evaluation1/yearPredictMSD/disSVRG-50-without-tricks.txt'
	fn_tricks_disSVRG='/Users/yawei/Documents/papers/asynchronsou and distributed stochastic gradient descent with variance reduction /figures/data/evaluation1/yearPredictMSD/disSVRG-50-tricks.txt'
	fn_petuumSGD='/Users/yawei/Documents/papers/asynchronsou and distributed stochastic gradient descent with variance reduction /figures/data/evaluation1/yearPredictMSD/petuumSGD-50.txt'
	fn_SSGD='/Users/yawei/Documents/papers/asynchronsou and distributed stochastic gradient descent with variance reduction /figures/data/evaluation1/yearPredictMSD/SSGD.txt'
